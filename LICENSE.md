...
2.  Make sure every part of the source code is available under this license or [AGPLv3.0](https://www.gnu.org/licenses/agpl-3.0.en.html) or [GPLv3.0](https://www.gnu.org/licenses/gpl-3.0.en.html).
